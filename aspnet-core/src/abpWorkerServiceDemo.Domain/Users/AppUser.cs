...
namespace abpWorkerServiceDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update abpWorkerServiceDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update abpWorkerServiceDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
