...
{
    public static class abpWorkerServiceDemoEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE abpWorkerServiceDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
